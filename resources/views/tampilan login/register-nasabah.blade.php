            ...
            <div class="p-6 lg:w-1/2" id="register-form">
                ...
                <form action="" class="flex flex-col">
                    <div class="flex flex-col mb-3 relative">
                        ...
                        <input type="text" id="register-name" placeholder="Masukkan nama anda"
                    ...
                    <div class="flex flex-col mb-3 relative">
                        ...
                        <input type="password" id="register-password" placeholder="Buat password anda"
                    ...
                    <div class="flex flex-col mb-3 relative">
                        ...
                        <label for="register-confirm-password" class="mb-1 text-gray-900 text-sm">Konfirmasi
                            Password</label>
                        <input type="password" id="register-confirm-password" placeholder="Masukkan ulang password anda"
                            class="px-3 py-2 border-2 border-slate-300 rounded-md max-w-full focus:outline-none focus:border-hijau text-sm" />
                    </div>
                    <button type="submit"
                ...
                <p class="text-gray-900 text-sm">
                    Sudah memiliki akun?
                    <a href="#" class="text-blue-500 font-bold underline" onclick="showLogin()">Login</a>
                </p>
            </div>
        </div>
    </main>
