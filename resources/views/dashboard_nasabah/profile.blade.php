            ...
            <div class="p-6 bg-white shadow-md rounded-lg">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" id="currentPassword"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md" placeholder="Current Password">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" id="confirmPassword"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md" placeholder="Confirm New Password">
                </div>
                <div class="mt-6 flex justify-end">
